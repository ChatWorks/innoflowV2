        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <div className="text-2xl font-bold mb-2">{getTotalProjectDeclarable(deliverables, phases)}h</div>
            ...
            <CardContent className="p-4">
              ...
              <div className="w-full bg-orange-100 dark:bg-orange-900/20 rounded-full h-2">
                <div 
                  ...
                  style={{ 
                    width: `${Math.min(100, (formatTimeToHours(totalProjectTimeSpent) / Math.max(1, getTotalProjectDeclarable(deliverables, phases))) * 100)}%` 
                  }}
                />
              </div>
              <div className="text-xs text-muted-foreground mt-1">
                {getTotalProjectDeclarable(deliverables, phases) > 0 
                  ? `${Math.round((formatTimeToHours(totalProjectTimeSpent) / getTotalProjectDeclarable(deliverables, phases)) * 100)}% van budget`
