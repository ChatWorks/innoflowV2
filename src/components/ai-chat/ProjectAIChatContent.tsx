...
export const ProjectAIChatContent: React.FC<ProjectAIChatContentProps> = ({
  ...
  const { messages, sendAIMessage, isSendingAI } = useProjectChatMessages(sessionId);
  ...
  const getQuickActions = () => {
    const actions = [
      "Wat is de huidige projectstatus?",
      "Welke taken zijn nog open?",
      "Hoe loopt dit project qua tijd en budget?",
      "Wat zijn de grootste risico's?",
      "Welke deliverables zijn voltooid?",
    ];
